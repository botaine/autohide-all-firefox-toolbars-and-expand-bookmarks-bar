...
$defaultLocation = Read-Host "  Did you install Firefox to the default location? (Y/N)"
...
Write-Host "`n  To find your Firefox profile location, open Firefox and in the" -ForegroundColor Yellow
